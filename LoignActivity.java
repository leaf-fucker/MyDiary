...
public class LoignActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign=(Button)findViewById(R.id.signin_button);
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(account.equals("admin")&&password.equals("123456")){
                    ...
                    editor.apply();
                    //显示登录成功并跳转到主界面活动
                    Toast.makeText(LoignActivity.this,"登录成功",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(LoignActivity.this, MainActivity.class);
                    intent.putExtra("name",account);
                    startActivity(intent);
                    //结束当前活动
                    LoignActivity.this.finish();
                    finish();
                }
                //用户名或密码错误
                else{
                    Toast.makeText(LoignActivity.this,"登录失败,请重新输入！",Toast.LENGTH_SHORT).show();
                }
            }
        });
